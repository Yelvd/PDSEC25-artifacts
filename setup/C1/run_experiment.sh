...
python3 $hemocell/Hemocell-Performance-Benchmarks/scripts/setup-experiment.py -i ./ -o setups/ -n $uniqdir -t $iters -s 600,400,200 -p $(($ppn * $nodes)) --fli_fluid $imbalance --fli_part 0 --fli_part_base 65 --fli_part_stack 1
